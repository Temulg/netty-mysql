...
implements StreamingNotifiable {
	public CommunicationsException(
		...
		this(ExceptionFactory.createLinkFailureMessageBasedOnHeuristics(
			conn.getConfig(),
	...
	public void setWasStreamingResults() {
		exceptionMessage = Messages.getString(
			"CommunicationsException.ClientWasStreaming"
		);
	}

        private static final long serialVersionUID = 0x3a3318a01cd54846L;
